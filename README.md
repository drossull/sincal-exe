...
1. Ejecuta el instalador oficial de la release `v29.0.17`.
...
- `Setup_SINCAL_v29.0.17.exe`
- `SINCAL_App_v29.0.17.zip`
- `SINCAL_AutoCAD_v29.0.17.zip`
- `release-manifest_v29.0.17.json`
- `SHA256SUMS.txt`
