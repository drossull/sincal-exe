...
1. Ejecuta el instalador oficial de la release `v29.0.9`.
...
- `Setup_SINCAL_v29.0.9.exe`
- `SINCAL_App_v29.0.9.zip`
- `SINCAL_AutoCAD_v29.0.9.zip`
- `release-manifest_v29.0.9.json`
- `SHA256SUMS.txt`
