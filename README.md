...
1. Ejecuta el instalador oficial de la release `v29.0.2`.
...
- `Setup_SINCAL_v29.0.2.exe`
- `SINCAL_App_v29.0.2.zip`
- `SINCAL_AutoCAD_v29.0.2.zip`
- `release-manifest_v29.0.2.json`
- `SHA256SUMS.txt`
