...
1. Ejecuta el instalador oficial de la release `v29.0.16`.
...
- `Setup_SINCAL_v29.0.16.exe`
- `SINCAL_App_v29.0.16.zip`
- `SINCAL_AutoCAD_v29.0.16.zip`
- `release-manifest_v29.0.16.json`
- `SHA256SUMS.txt`
