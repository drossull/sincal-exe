...
1. Ejecuta el instalador oficial de la release `v29.0.1`.
...
- `Setup_SINCAL_v29.0.1.exe`
- `SINCAL_App_v29.0.1.zip`
- `SINCAL_AutoCAD_v29.0.1.zip`
- `release-manifest_v29.0.1.json`
- `SHA256SUMS.txt`
