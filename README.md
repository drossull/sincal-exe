...
1. Ejecuta el instalador oficial de la release `v29.0.11`.
...
- `Setup_SINCAL_v29.0.11.exe`
- `SINCAL_App_v29.0.11.zip`
- `SINCAL_AutoCAD_v29.0.11.zip`
- `release-manifest_v29.0.11.json`
- `SHA256SUMS.txt`
