...
1. Ejecuta el instalador oficial de la release `v29.0.18`.
...
- `Setup_SINCAL_v29.0.18.exe`
- `SINCAL_App_v29.0.18.zip`
- `SINCAL_AutoCAD_v29.0.18.zip`
- `release-manifest_v29.0.18.json`
- `SHA256SUMS.txt`
