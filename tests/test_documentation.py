...
class DocumentationTests(unittest.TestCase):
    def test_tutorials_cover_every_published_lisp_command(self):
        ...
        expected = {
            "SINCAL", "BV", "BTORIENT", "TXT-JOIN", "CEVIADA", "CPOL", "DEL-VIN", "DIMEL", "DL2",
...
class WebInstallerConfigurationTests(unittest.TestCase):
    ...
    def test_web_payload_bundles_core_resources_but_not_regional_maps(self):
        ...
        self.assertIn("assets/fonts/HelveticaNeueRoman.ttf", build_script)
        self.assertIn("assets/fonts/HelveticaNeueBold.ttf", build_script)
