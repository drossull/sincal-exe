...
class ModEstribos(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.tab_estribo = ctk.CTkTabview(self, fg_color="#1E1E1E", segmented_button_selected_color="#005BBF")
        ...
        frame_vistas.grid(row=8, column=0, columnspan=6, sticky="ew", pady=(20, 0))
        ...
        for txt, vista in vistas:
            ...
            btn_v = ctk.CTkButton(frame_btn, text=txt, font=fuente_normal, corner_radius=0, height=40, fg_color="transparent", border_width=1, border_color="#007FFF", text_color="#CCCCCC", hover_color="#444444", command=lambda v=vista: self.generar_vista_cad(v))
            btn_v.pack(side="left", expand=True, fill="x")
            btn_d = ctk.CTkButton(frame_btn, text="D", font=fuente_subtitulo, corner_radius=0, height=40, width=30, fg_color="#007FFF", hover_color="#0066CC", text_color="#FFFFFF", command=lambda v=vista: self.generar_despiece_cad(v))
