...
class TabDocs(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.menu_container = ctk.CTkFrame(m, width=220, fg_color="transparent")
        ...
        self.lbl_wiki_title = ctk.CTkLabel(c_cont, text="Seleccione un tema", font=fuente_subtitulo, text_color=color_titulo)
        self.lbl_wiki_title.pack(anchor="w", padx=20, pady=(10, 0))
        
        self.txt_wiki_content = ctk.CTkTextbox(c_cont, font=fuente_normal, fg_color="transparent", text_color=color_texto, wrap="word", border_width=0)
        ...
        for t, cmd in opciones:
            lbl = ctk.CTkLabel(self.menu_container, text=t, font=fuente_menu, text_color=color_texto, cursor="hand2")
    ...
    def mostrar_readme(self): 
        ...
        self.mostrar_texto_wiki("README", open(r, 'r', encoding='utf-8').read() if os.path.exists(r) else "No disponible. Actualiza la aplicación.")
    ...
    def mostrar_procesamiento_lote(self): 
        self.mostrar_texto_wiki("Lotes", "Scripts masivos por PowerShell corporativo.")